...
describe('Library module', () => {
  ...
  describe('when options arguments is given', () => {
    it('should include default options on all response objects', () => {
      ...
      expect(response.unprocessableEntity()).toEqual({statusCode: 422, headers: options.headers, body: options.body });
    ...
    it('should give preference to response arguments over default options', () => {
      ...
      expect(response.unprocessableEntity()).toEqual(expect.objectContaining(expected));
